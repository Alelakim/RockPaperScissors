...
namespace RockPaperScissorsTests.ControllersTests
{
    internal class GameControllerTests
    {
        //Här hade jag tänkt skriva integrationstester för min controller men eftersom jag aldrig har skrivit integrationstester
        //så fick jag inse att det hinner jag faktiskt inte göra i och med att jag tänker lämna in då jag behöver lägga min tid på annat
